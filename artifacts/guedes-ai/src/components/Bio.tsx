    ...
    <section id="trajetoria" className="w-full py-32 px-6">
      <div className="max-w-4xl mx-auto">
        ...
        >
          ...
          <div className="space-y-6 text-white/60 text-lg leading-relaxed max-w-3xl mb-12">
            <p>
          ...
          <blockquote className="border-l-2 border-indigo-500 pl-6 py-1 mb-12 max-w-3xl">
            <p className="font-serif italic text-2xl md:text-3xl text-white/80 leading-snug">
          ...
          <div className="flex flex-wrap gap-3">
            {[
              ...
              <span 
                key={i}
                className="text-[11px] font-medium text-white/60 border border-white/10 bg-white/[0.03] rounded-full px-4 py-1.5"
              >
                {pill}
              </span>
            ))}
