    ...
    <section id="hero" className="relative min-h-[100dvh] w-full flex items-center justify-center pt-24 pb-12 px-6">
      ...
      <div className="relative z-10 flex flex-col items-center text-center max-w-5xl mx-auto w-full">
        ...
        <motion.p 
          ...
          animate="visible"
          variants={staggerVariants}
          className="text-lg md:text-xl text-foreground/50 leading-relaxed mb-10 max-w-2xl"
        >
        ...
        >
          ...
          <a 
            ...
            className="w-full sm:w-auto border border-border text-foreground/70 hover:border-foreground/30 hover:text-foreground hover:bg-foreground/[0.04] text-sm px-8 py-3.5 rounded-full transition-all"
        ...
        <motion.div 
          ...
          animate="visible"
          variants={staggerVariants}
          className="flex flex-wrap items-center justify-center gap-6 md:gap-10 text-xs md:text-sm text-foreground/40 font-mono"
        >
